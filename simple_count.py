#!/usr/bin/env python3
"""
Simple script to count fields and placeholders
"""

# The INSERT statement from db_module.py (simplified)
...
def count_fields_and_placeholders():
    ...
    print("=== SIMPLE COUNT ANALYSIS ===")
    print()
    
    # Count fields - split by comma and count
    ...
    for i, line in enumerate(values_lines):
        if line.strip():
            count = line.count('%s')
            print(f"Line {i+1}: {count} placeholders")
